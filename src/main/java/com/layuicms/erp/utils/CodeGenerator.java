package com.layuicms.erp.utils;
...
//        gc.setServiceName("%sService");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/erp1207?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        ...
        pc.setModuleName(scanner("模块名(包名)na"));
//        pc.setModuleName("sys");
        pc.setParent("com.layuicms");//controller entity  service  service.impl
